...
st.sidebar.button('Linkedin', 'https://www.linkedin.com/in/jo%C3%A3o-pedro-diniz-b997b5220/','Me siga no Linkedin', icon_size )

st.sidebar.button('Github', 'https://github.com/dinizjp', 'Acesse meus códigos' , icon_size)
